  ...
  render() {
    return(
      <div>
        ...
        <h1>Unique Visitors Non Admin: {this.state.stats.unique_visitors_non_admins}</h1>
        <h1>Unique Page Views Non Admin: {this.state.stats.unique_page_views_non_admins}</h1>
      </div>
    )
  }
}
